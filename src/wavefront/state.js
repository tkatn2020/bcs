...
const initial = {
  ...
  v3frame: {
    ...
    templeBend: 60,   // 다리 몸통 밴딩 (0~90°, 0 = 직선, 90 = 머리 곡률 밀착)
    endpiece: 0,      // 엔드피스(힌지) 높이 오프셋 (-6~+6mm)
  },
  // 두상 조정 (얼굴 메시 변형 — 광학 무관, 시각/피팅 물리)
  // 키는 아바타 해부학 기준: 오른쪽 = 코드 −x(earL/side<0), 왼쪽 = +x(earR/side>0)
  v3head: {
    earRightY: 0,  // 아바타 오른쪽 귀 상하 (mm, + = 위)
    earRightZ: 0,  // 아바타 오른쪽 귀 앞뒤 (mm, + = 앞/눈쪽, − = 뒤/뒤통수)
    earLeftY: 0,   // 아바타 왼쪽 귀 상하
    earLeftZ: 0,   // 아바타 왼쪽 귀 앞뒤
